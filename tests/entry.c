...
void primitive_data_types() {
  ...
  struct Entry entry_int =
    entry_constructor(&key, sizeof(key), &data_int, sizeof(data_int));
  ...
  struct Entry entry_int_array =
    entry_constructor(&key, sizeof(key), &data_int_array, sizeof(int) * size_int);
  ...
  struct Entry entry_char =
    entry_constructor(&key, sizeof(key), &data_char, sizeof(data_char));
  ...
  struct Entry entry_char_array =
    entry_constructor(&key, sizeof(key), &data_char_array, sizeof(int) * size_char);
  ...
  struct Entry entry_max =
    entry_constructor(&key, sizeof(key), &data_max, sizeof(data_max));
